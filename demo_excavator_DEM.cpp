...
#include "irrlicht_interface/CHbodySceneNode_DEM.h"
#include "irrlicht_interface/CHbodySceneNodeTools_DEM.h"
#include "irrlicht_interface/CHirrAppInterface_DEM.h"
...
#define springCoef 2000 /*39240.0*/
...
int main(int argc, char* argv[])
{
        ...
        ChSystem mphysicalSystem(120000, 500);
        ...
        ChSharedPtr<ChBodyDEM> mrigidBody_Ptr;
        ...
        mrigidBody = (ChBodySceneNode*)addChBodySceneNode_easyBox(
                                                                                        ...
                                                                                        ChVector<>(1000,5,410) );
        mrigidBody_Ptr = (ChSharedPtr<ChBodyDEM>)mrigidBody->GetBody();
        mrigidBody_Ptr->SetSpringCoefficient(springCoef);
        mrigidBody_Ptr->SetDampingCoefficient(dampingCoef);
        mrigidBody->GetBody()->SetBodyFixed(true);
    ...
    int savestep = 10 * periodExtension;
        ...
        fstream outFileTime;
        outFileTime.open("simTimeDEM_CPU.txt", ios::out);
